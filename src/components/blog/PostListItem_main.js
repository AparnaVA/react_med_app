...
function PostListItem(props) {
    ...
    <div className="card-body">
        ...
        <Link to={"/blog/medicine/"+props.post.id+"/edit"} className="btn btn-warning float-right">Edit</Link>
        <Link to={"/blog/medicine/"+props.post.id} className="btn btn-info float-right">View</Link>
        <ConfirmationModal
          isOpen={isModalOpen}
